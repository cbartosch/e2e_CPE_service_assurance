...
`persistence.checkpointer.checkpointer_scope` -- an async context manager, because the Postgres
saver owns a connection -- and `persistence.serde.build_serde`; everything else here is an
